...
A fork of https://github.com/kibae/onnxruntime-server - I will attempt to embed a softmax function in the returned Onnx data, as it makes more sense to carry out that calculation in C than send it back to Python on another device to be calculated there. But let's see - as I'm not any good at any of the Cs!
